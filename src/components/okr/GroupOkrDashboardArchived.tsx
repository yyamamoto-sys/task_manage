// src/components/okr/GroupOkrDashboardArchived.tsx
//
// 【アーカイブ・2026-08-10】OKRモードのグループ側を白紙にする方針（山本さん指示）により、
// 現在どこからも描画されない。コードは将来の再設計のため保管している。
// 復帰手順は src/components/okr/ARCHIVED.md 参照（要約：このファイルの内容を
// OkrDashboardView.tsx に丸ごと戻し、MainLayout.tsx から selectedKrId/onSelectKr/
// activeTool/onSetActiveTool の4propsを再度渡す）。
//
// 元は src/components/okr/OkrDashboardView.tsx（〜v3.39）そのもの。以下は当時の説明：
...
export function GroupOkrDashboardArchived({
