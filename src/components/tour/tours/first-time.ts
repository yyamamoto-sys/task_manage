...
export const firstTimeTour: Tour = {
  ...
  steps: [
    ...
    {
      id: "ai-mode-meeting",
      target: "ai-mode-tab-meeting",
      placement: "bottom",
      skipIfMissing: true,
      title: "📄 資料インプット：文書からタスクを自動登録",
      body: "↑ このタブをクリックすると「資料インプット」モードに切り替わります。\n\n議事録・会議メモ・資料・報告書などを貼り付けると：\n・新規タスクの候補（誰が・何を・いつまでに）\n・既存タスクのステータス変更候補\n\nをAIが自動で提案します。確認して選ぶだけ、入力作業がほぼゼロに。\n\n💡 多くのメンバーに活用されています。",
    },
    {
      id: "fab",
      dim: false,
    ...
    },
    {
      ...
      placement: "left",
      title: "📊 PJ単体の AI 分析",
      body: "← このボタンでその PJ の健全性をAIが分析します。\n\n進捗・リスク・担当者の偏り・次の一手を一気に洗い出せます。\n\n💡 左サイドバーのプロジェクト一覧から PJ を選ぶと、このボタンがダッシュボード上部に現れます。",
    },
    {
      id: "okr-mode",
      target: "app-mode",
