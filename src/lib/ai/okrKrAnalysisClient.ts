...
【linked_pj_names（このTFに貢献するPJの名前）が与えられている場合】
- TFごとの状況で「このTFに貢献しているPJ」を1〜2件触れる（例：「○○PJと△△PJが推進中」）
- PJ間でTFを共有している場合、リソース配分・優先度の偏りを言及する
- linked_pj_names が空のTFは「このTFに紐づくPJが未設定」として TF 単体で評価する
