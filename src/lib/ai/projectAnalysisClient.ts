...
【OKR寄与の観点（linked_tf_numbers が与えられている場合）】
- このPJが貢献するTFが明示されている場合、「気になる点・リスク」と「次の一手」で
  OKRへの影響を1〜2件触れる（例：「TF1-2 への寄与PJなので KR① 達成に直接効く」）
- TFやKRのタイトルは無理に推測せず、与えられた番号や名前を使うこと`;
