...
export const layoutEn: Record<keyof typeof layoutJa, string> = {
  ...
  "layout.sidebar.showArchivedLabel": "Show archived",
  "layout.sidebar.showArchivedOn": "Click to also show archived projects",
  "layout.sidebar.showArchivedOff": "Click to hide archived projects",
